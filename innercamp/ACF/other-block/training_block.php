<?php
/**
 * Block template file: ACF/other-block/training_block.php
 *
 * Training Block Block Template.
 *
...
?>
<section <?php echo 'sssss' . $block['anchor'] . 'dddd' . $block['id'] ?>
  <?php echo(!empty($id) ? 'id="' . esc_attr($id) . '"' : '') ?>
    class="corporate__6 <?php echo esc_attr($classes); ?>">
  <div class="container">
    <div class="row">
      <div class="grid">
        ...
        <div class="traning-wrapper grid-item">
          <div class="traning">
            <h4 class="title">
              ...
              <?php the_field('title_list'); ?></h4>
            <div class="works">
              <?php
              if (have_rows('list_items')) :
                while (have_rows('list_items')) : the_row(); ?>
                  <span class="item">
                        <img src="<?= get_template_directory_uri(); ?>/img/corporate/mark.svg"
                             alt=""><?php the_sub_field('item'); ?></span>
                <?php
                endwhile;
              endif; ?>
            </div>
