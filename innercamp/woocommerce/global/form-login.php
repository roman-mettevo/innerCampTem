...
<!--  yourtheme/woocommerce/global/form-login.php  -->
...
<form class="woocommerce-form woocommerce-form-login login" method="post"
    ...
    <p class="form-row">
        ...
        <button type="submit"
            class="bundle woocommerce-button button woocommerce-form-login__submit<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>"
            name="login"
