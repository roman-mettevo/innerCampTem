...
<style>
  ...
  .product-template-tpl-product-breathwork-levels-one-two-page .testimonials-link {
    height: 365px;
  }
  .product-template-tpl-product-breathwork-levels-one-two-page .testimonials-link img {
    height: 100%;
    object-fit: cover;
  }
