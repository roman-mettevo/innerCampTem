...
get_header(); ?>
        ...
        <div class="row">     
          <div class="col m12 s12 l12 xl12">
            ...
            <div class="box__">
              ...
              <p>The InnerCamp Breathwork Method ® gives you a professional advantage in assisting your clients to unleash their true potential through a cutting-edge breathwork technology proven by science.</p><a class="bundle" href="javascript:;">Book now</a>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="row">
          <div class="col m12 s12 l12 xl9 offset-xl3">
            <div class="block__top scroll__init">
              <div class="box__img"><img src="<?= get_template_directory_uri(); ?>/img/breathwork-levels-one-two__2_img_1.png" alt="logo">
                <div class="info">Levels 1 + 2</div>
              </div>
              <div class="box__content">
                <div class="price__"><span class="top_price">Price:</span><span class="prise">2200€</span></div><a class="bundle" href="#">Start my journey</a>
                <hr><span class="calendar">4 months</span><span class="video">65+ videos</span><span class="clock">300 hours in total</span><span class="status online">onsite</span>
              </div>
              <div class="box__bottom">
                <p>You have the option to purchase the levels <span>separately.</span><span> <a href="#">See details</a></span></p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div class="block__green scroll__init">
              <div class="box__">
                ...
                <div class="bottom-row"> 
                  <p>Our courses are accredited by the leading independent CPD accreditation institution.</p><img src="<?= get_template_directory_uri(); ?>/img/brand__03.svg" alt="logo">
                </div>
              </div>
              <div class="img__"><img src="<?= get_template_directory_uri(); ?>/img/brand__01.svg" alt="logo"><img src="<?= get_template_directory_uri(); ?>/img/brand__02.svg" alt="logo"><img src="<?= get_template_directory_uri(); ?>/img/brand__03.svg" alt="logo"></div>
            </div>
          </div>
        </div>
        <div class="row">
            ...
            <div class="block__help scroll__init">
              <div class="cont__">
                ...
                <ul>
                  ...
                  <li class="cheked">Strengthen the immune system by boosting antibodies and potentially reducing inflammation.</li>
                </ul>
              </div>
              <div class="img__"><img src="<?= get_template_directory_uri(); ?>/img/breathwork-levels-one-two__2_img_2.png" alt="logo"></div>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col m12 s12 l12 xl9 offset-xl3">
            ...
            <div class="block__next">
              <div class="img__"><img src="<?= get_template_directory_uri(); ?>/img/breathwork-levels-one-two__2_img_3.png" alt="logo"></div>
              <div class="cont__">
                <div class="box__">
                  <p>Our course is based on the main Conscious Connected Breathwork techniques and is split in two levels.</p><a class="download" href="#">Download Brochure</a>
                </div>
              </div>
            </div>
          </div>
              ...
              <div class="program-content-wrap">
                <div class="program-content active" id="tab-1">
                  ...
                  <ul class="program-list">
                    ...
                    <li class="program-item">
                      <h4 class="item-title">Customise your own breathwork sessions</h4><span class="item-time">20 hours</span>
                      <ul class="subitem-list">
                ...
                <div class="splide" id="facilitator-slider" aria-roledescription="carousel">
                  <div class="splide__track">
                    <ul class="splide__list">
                      ...
                      <li class="splide__slide">
                        <div class="coach-item">
                          <div class="coach-photo"><img src="<?= get_template_directory_uri(); ?>/img/team/coach_2.webp" alt="">
                            <div class="single-category">InnerCamp founder</div>
                          </div>
                          <div class="coach-content">
                            <h2 class="coach-name">Alexis Alcal&aacute;</h2>
        ...
        <div class="row">
          <div class="col m12 s12 l12 xl9 offset-xl3">
            <article class="certificate" id="certificate">
              <div class="certificate-photo"><img src="<?= get_template_directory_uri(); ?>/img/breathwork-teacher/certificate-without-shadow1.png" alt=""></div>
            ...
            <div class="session-wrap">
              ...
              <article class="session" id="session">
                <div class="top-row">
                  <div class="session-content-wrap">
                    <div class="session-schedule">
                      ...
                      <div class="calen">Thursdays (biweekly)</div><span class="schedule-date">Sep 13, Sep 27, Oct 11, Oct 25, Nov 8, Nov 22<strong>(2023)</strong></span><a class="bundle-check" href="#">Check my local time here</a>
                    </div>
                ...
                <div class="bottom-row">
                  ...
                  <p>During the Level 2 (Facilitator training), we will ask you to bring a friend or a few friends at home to practice how to facilitate breathwork. This part of the course is the most important one as you will start doing the "real" work. For us it is crucial to see you facilitating and guide you during this process.</p>
                </div>
              </article>
            </div>
          </div>
            ...
            <div class="testimonials-slider splide" id="bodywork-testimonials-slider">
              <div class="splide__track">
                <div class="splide__list">
                  <div class="splide__slide testimonials-item"><a class="testimonials-link" data-fancybox="" href="https://www.youtube.com/watch?v=2xeEKF8O0Ek&amp;list=PLIPLVbRO-ESui8w3ZiW817_ITWg6psx5u&amp;ab_channel=innercamp"><img src="./img/bodywork-1/testimonials.jpg" alt=""></a></div>
                  <div class="splide__slide testimonials-item"><a class="testimonials-link" data-fancybox="" href="https://www.youtube.com/watch?v=2xeEKF8O0Ek&amp;list=PLIPLVbRO-ESui8w3ZiW817_ITWg6psx5u&amp;ab_channel=innercamp"><img src="./img/bodywork-1/testimonials.jpg" alt=""></a></div>
                  <div class="splide__slide testimonials-item"><a class="testimonials-link" data-fancybox="" href="https://www.youtube.com/watch?v=2xeEKF8O0Ek&amp;list=PLIPLVbRO-ESui8w3ZiW817_ITWg6psx5u&amp;ab_channel=innercamp"><img src="./img/bodywork-1/testimonials.jpg" alt=""></a></div>
                  <div class="splide__slide testimonials-item"><a class="testimonials-link" data-fancybox="" href="https://www.youtube.com/watch?v=2xeEKF8O0Ek&amp;list=PLIPLVbRO-ESui8w3ZiW817_ITWg6psx5u&amp;ab_channel=innercamp"><img src="./img/bodywork-1/testimonials.jpg" alt=""></a></div>
                  <div class="splide__slide testimonials-item"><a class="testimonials-link" data-fancybox="" href="https://www.youtube.com/watch?v=2xeEKF8O0Ek&amp;list=PLIPLVbRO-ESui8w3ZiW817_ITWg6psx5u&amp;ab_channel=innercamp"><img src="./img/bodywork-1/testimonials.jpg" alt=""></a></div>
            ...
            <article class="level-exposition">
              ...
              <ul class="exposition-list">
                ...
                <li class="exposition-item-row">
                  ...
                  <div class="level-item"><img src="<?= get_template_directory_uri(); ?>/img/breathwork-teacher/check-circle-2.svg" alt=""><span>yes</span></div>
                  <div class="level-item full-program"><img src="<?= get_template_directory_uri(); ?>/img/breathwork-teacher/check-circle-2.svg" alt=""><span>yes</span></div>
                </li>
                <li class="exposition-item-row">
                ...
                <li class="exposition-item-row">
                  ...
                  <div class="level-item"><img src="<?= get_template_directory_uri(); ?>/img/tantra/red-circle.svg" alt=""><span>no</span></div>
                  <div class="level-item full-program"><img src="<?= get_template_directory_uri(); ?>/img/breathwork-teacher/check-circle-2.svg" alt=""><span>yes</span></div>
                </li>
                <li class="exposition-item-row">
    ...
    <section class="breathwork-levels-one-two__12">
      <div class="container">
        <div class="row">
          <div class="col m12 s12 l12 xl9 offset-xl3">
            <article class="book-training" id="book-now">
              ...
              <div class="book-training-wrap">
                ...
                <div class="middle-small-block">
                  ...
                  <div class="choose-price">
                    <div class="price-item"><span class="price">550&euro;</span><span class="price-type">4 instalments</span></div>
