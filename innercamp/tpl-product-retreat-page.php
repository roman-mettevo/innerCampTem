...
<?php if (have_rows('retreat_pages')): ?>
  <?php while (have_rows('retreat_pages')) : the_row(); ?>
    <?php if (get_row_layout() == 'section_1') : ?>
      <section class="tantra-retreat__1"
               data-menuscroll <?php if (get_the_post_thumbnail_url()) { ?> style="background: linear-gradient(0deg,rgba(0,0,0,.5),rgba(0,0,0,.5)), url(<?= get_the_post_thumbnail_url(); ?>) no-repeat center/cover;" <?php } ?>>
        <div class="container">
          <div class="row">
            <div class="col m12 s12 l12 xl12">
              ...
              <ul class="short-info-list">
                ...
                <li class="short-info-item calendar-item"><?php the_field('start_datetime', $product_id); ?>
                  - <?php the_field('end_datetime', $product_id); ?></li>
              ...
              <form id="form_add_<?php echo get_the_ID(); ?>" method='POST' action='javascript:void(null);'>
                ...
                <a data-add="<?php echo get_the_ID(); ?>" class="add__ bundle"
                   name="add"><?php echo __('Book now'); ?></a>
                <button hidden type="submit" name="add" class="tt-btn-close" data-delete="<?php echo get_the_ID(); ?>">
                  x
                </button>
              </form>
            </div>
                  ...
                  if (get_row_layout() == 'section_2') {
                    if (have_rows('navigation')) :
                      while (have_rows('navigation')) : the_row(); ?>
                        <li><a
                              href="#<?php the_sub_field('navigation_id'); ?>"><?php the_sub_field('navigation_item_title'); ?></a>
                        </li>
                      <?php endwhile;
                    endif;
            ...
            <div class="retreat-product-card">
              ...
              <div class="retreat-product-card-body">
                <form id="form_add_<?php echo get_the_ID(); ?>" method='POST' action='javascript:void(null);'>
                  ...
                  <input type="hidden" name="action" value="addcart_prod">
                  <a data-add="<?php echo get_the_ID(); ?>" class="add__ bundle"
                     name="add"><?php echo __('Start my journey'); ?></a>
                      ...
                      <div class="schedule-grid-item">
                        <div class="schedule-header">
                          ...
                          <?php if ($first_item_image) : ?>
                            <img src="<?php echo esc_url($first_item_image['url']); ?>"
                                 alt="<?php echo esc_attr($first_item_image['alt']); ?>"/>
                          <?php endif; ?>
                        </div>
                      ...
                      <div class="schedule-grid-item">
                        <div class="schedule-header">
                          ...
                          <?php if ($second_item_image) : ?>
                            <img src="<?php echo esc_url($second_item_image['url']); ?>"
                                 alt="<?php echo esc_attr($second_item_image['alt']); ?>"/>
                          <?php endif; ?>
                        </div>
                        <div class="schedule-body">
                      ...
                      <div class="schedule-grid-item">
                        <div class="schedule-header">
                          ...
                          <?php if ($third_item_image) : ?>
                            <img src="<?php echo esc_url($third_item_image['url']); ?>"
                                 alt="<?php echo esc_attr($third_item_image['alt']); ?>"/>
                          <?php endif; ?>
                        </div>
                        <div class="schedule-body">
                      ...
                      <div class="schedule-grid-item">
                        <div class="schedule-header">
                          ...
                          <?php if ($fourth_item_image) : ?>
                            <img src="<?php echo esc_url($fourth_item_image['url']); ?>"
                                 alt="<?php echo esc_attr($fourth_item_image['alt']); ?>"/>
                          <?php endif; ?>
                        </div>
                        <div class="schedule-body">
              ...
              <div class="img">
                ...
                <?php if ($bottom_image) : ?>
                  <img src="<?php echo esc_url($bottom_image['url']); ?>"
                       alt="<?php echo esc_attr($bottom_image['alt']); ?>"/>
                <?php endif; ?>
              </div>
              <div class="yogi-text">
                  ...
                  <div class="splide__list">
                    <?php while (have_rows('image_and_map_slider')) : the_row(); ?>
                      ...
                      <div class="photo-and-map-slide splide__slide"
                           style="background: linear-gradient(169.67deg,rgba(0,0,0,0) 68.62%,rgba(0,0,0,.73) 92.29%), url(<?php echo esc_url($slide_image['url']); ?>)">
                        <iframe
    ...
    <?php else : ?>
      ...
      <section class="tantra-retreat__11">
        ...
        if (method_exists($product, 'get_stock_status')) {
          $stock_status_text = $product->get_stock_status(); // For version 3.0+
        } else {
          $stock_status_text = $product->stock_status; // Older than version 3.0
        }
        if ($stock_status_text === 'instock') {
          $stock_status = true;
        }
        echo $stock_status_text;
        ?>
              ...
              <div class="col m12 s12 l12 xl9 offset-xl3">
                <div class="innercamp-retreat">
                  <div class="innercamp-retreat-header">
                    ...
                    ?>
                    <h2 class="title"><?php the_sub_field('title'); ?><?php echo $stock_status_text ?></h2>
                    <?php
                    $date_start = $date_end = '';
                    if (get_field('start_datetime')) {
                      $date_start = get_field('start_datetime');
                    }
                    if (get_field('end_datetime')) {
                      $date_end = get_field('end_datetime');
                    }
                    if ($date_start && $date_end){?>
                      <span class="retreat-date"><?php echo $date_start . ' - ' . $date_end; ?></span>
                      <?php
                    }
                    ?>
                  </div>
                  <div class="innercamp-retreat-body">
                    ...
                    <ul class="retreat-room-list">
                      <li data-elem="0" class="retreat-room-item apartment-item">
                        ...
                        <div class="room-price"><?php the_sub_field('single_room_price'); ?></div>
                      </li>
                      <li data-elem="1" class="retreat-room-item apartment-item">
                        <ul class="retreat-room-bads">
                          <li>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="room-price"><?php the_sub_field('double_room_price'); ?></div>
                      </li>
                      <li data-elem="2" class="retreat-room-item  apartment-item">
                        <ul class="retreat-room-bads">
                          <li>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                 xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="room-price"><?php the_sub_field('glamping_price'); ?></div>
                      </li>
                    </ul>
                  </div>
                  <span class="bundle add-custom-js">
                  Proceed to checkout
                </span>
                </div>
              </div>
...
<?php if (0){ ?>
                ...
                if (have_rows('box_list')) { ?>
                  <div class="battoms__"><?php
                    while (have_rows('box_list')) : the_row(); ?>
                      ...
                      <a class="data"><?php the_field('start_datetime', $product_id); ?>
                        - <?php the_field('end_datetime', $product_id); ?></a>
          ...
          <div class="col m12 s12 l12 xl9 offset-xl3">
            ...
            <div class="block__top">
              ...
              <div class="box__content">
                ...
                <hr>
                <span
                    class="data"><?php the_field('start_datetime', $product_id); ?> - <?php the_field('end_datetime', $product_id); ?></span>
  ...
  <section class="retreat__2">
    ...
    <div class="container">
      ...
      <?php if (have_rows('program_schedule')) : ?>
      <?php while (have_rows('program_schedule')) :
      the_row(); ?>
      <div class="row">
        <?php if (have_rows('first_item')) : ?>
          <?php while (have_rows('first_item')) : the_row(); ?>
      ...
      <div class="row">
            ...
            <div class="col m12 s12 l6 xl6 offset-xl3">
              <div class="box__">
                <div class="picture3">
                  ...
                  <?php if ($third_image) : ?>
                    <img src="<?php echo esc_url($third_image['url']); ?>"
                         alt="<?php echo esc_attr($third_image['alt']); ?>"/>
                  <?php endif; ?>
                </div>
                <div class="box__content">
                  <?php
        ...
        <?php endif; ?>
        <?php if (have_rows('fourth_item')) : ?>
        <?php while (have_rows('fourth_item')) :
        the_row(); ?>
        <div class="col m12 s12 l3 xl3">
          <div class="box__">
            <div class="picture3">
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col m12 s12 l9 xl9 offset-xl3 offset-l3 scroll__init" id="<?php the_sub_field('navigation_id'); ?>">
          ...
          <?php while (have_rows('navigation')) :
          the_row(); ?>
          <section class="col m12 s12 l9 xl9 offset-xl3 offset-l3 scroll__init"
                   id="<?php the_sub_field('navigation_id'); ?>">
            <?php endwhile; ?>
            <?php else : ?>
            <div class="col m12 s12 l9 xl9 offset-xl3 offset-l3">
              <?php endif; ?>
            ...
            <?php elseif (get_row_layout() == 'section_9') : ?>
              <div class="col m12 s12 l9 xl9 offset-xl3 offset-l3">
                        ...
                        <?php while (have_rows('image_and_map_slider')) : the_row(); ?>
                          <li class="splide__slide">
                            <div class="box__">
                              ...
                              <?php endif; ?>
                              <div class="map">
                                <iframe src="<?php the_sub_field('coordinates'); ?>" width="347" height="190"
                                        style="border:0;border-radius:34px;" allowfullscreen="" loading="lazy"></iframe>
                              </div>
                            </div>
                          </li>
                        <?php endwhile; ?>
                ...
                <div class="arrows"><a class="left_r previous-button" href="javascript:;">
                  ...
                  </a><a class="right_r next-button" href="javascript:;">
                    <svg width="45" height="16" viewbox="0 0 45 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                      <path
                          d="M44.7071 8.7071C45.0976 8.31658 45.0976 7.68341 44.7071 7.29289L38.3431 0.928929C37.9526 0.538404 37.3195 0.538405 36.9289 0.928929C36.5384 1.31945 36.5384 1.95262 36.9289 2.34314L42.5858 8L36.9289 13.6569C36.5384 14.0474 36.5384 14.6805 36.9289 15.0711C37.3195 15.4616 37.9526 15.4616 38.3431 15.0711L44.7071 8.7071ZM8.74228e-08 9L44 9L44 7L-8.74228e-08 7L8.74228e-08 9Z"
                          fill="#B68742"></path>
          ...
          <div class="remix">
            ...
            <div class="battoms">
              <form id="form_add_<?php echo get_the_ID(); ?>" method='POST' action='javascript:void(null);'>
                ...
                <input type="hidden" name="action" value="addcart_prod">
                <a data-add="<?php echo get_the_ID(); ?>" class="add__ bundle"
                   name="add"><?php echo __('Proceed to checkout'); ?></a>
                <button hidden type="submit" name="add" class="tt-btn-close" data-delete="<?php echo get_the_ID(); ?>">
                  x
                </button>
              </form>
